...
const SLIDES: Slide[] = [
  {
    ...
    subtitle: 'A plataforma que conecta pessoas e negócios com a moeda global',
    highlight: 'GLB',
  },
  {
    icon: 'message-circle',
    ...
    subtitle: 'Chat seguro, Vitrine de produtos e reservas com pagamento automático em',
    highlight: 'GLB',
  },
  {
    icon: 'credit-card',
    ...
    title: 'Sua Carteira Global',
    subtitle: 'Saldo em GLB, PIX, transferências e maquininha de cartão — tudo no bolso com',
    highlight: 'segurança',
  },
];
